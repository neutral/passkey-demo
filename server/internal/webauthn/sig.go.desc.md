# Purpose
Verify WebAuthn assertion signatures (ES256) over `SHA256(authenticatorData || SHA256(clientDataJSON))` with strict DER parsing (no trailing bytes) and low‑S enforcement.
