...
- `LoginOptions` / `LoginFinish`: minimal assertion request/response JSON shapes (binary fields as base64url strings).
...
# Refs
Refs: requirement R-ID-KEY; requirement R-SCHEMA-LITE; requirement R-PLAT-2; goal key-first-identity-cose; goal minimal-cbor-bundle
